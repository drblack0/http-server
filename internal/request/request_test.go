...
// todo: refactor tests to be request lines and the headers separately
func TestRequestLineParse(t *testing.T) {
	...
	fmt.Println("here are the headers: ", r.Headers)
	...
	// Test: Out of order request args
	r, err = RequestFromReader(strings.NewReader("/coffee GET HTTP/1.1"))
	require.Error(t, err)

	// Test: invalid version
	r, err = RequestFromReader(strings.NewReader("/coffee GET HTTP/1.3"))
	require.Error(t, err)
